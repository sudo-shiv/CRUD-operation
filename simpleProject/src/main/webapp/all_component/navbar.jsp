	...
	<div class="collapse navbar-collapse" id="navbarSupportedContent">
		<ul class="navbar-nav mr-auto">
			...
			<li class="nav-item"><a class="nav-link" href="addNotes.jsp"><i
					class="fa fa-plus" aria-hidden="true"></i>Add </a></li>


			<li class="nav-item"><a class="nav-link" href="showNotes.jsp"><i
					class="fa fa-address-book" aria-hidden="true"></i>View </a></li>
		</ul>
		...
		if (user != null) {
		%>
		<a href="" class="btn btn-dark my-2 my-sm-0 mr-2" data-toggle="modal" data-target="#exampleModal"
			type="submit"><i class="fa fa-user" aria-hidden="true"></i><%=  user.getName()%></a>
			
			
		<a href="LogoutServlet" class="btn btn-warning my-2 my-sm-0"
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
		...
		<a href="login.jsp" class="btn btn-dark my-2 my-sm-0 mr-2"
			type="submit"><i class="fa fa-sign-in" aria-hidden="true"></i>Login</a>
			
		<a href="register.jsp" class="btn btn-warning my-2 my-sm-0"
